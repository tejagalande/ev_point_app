...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(home: ChargingStationDetailsScreen());
  }
}


class ChargingStationDetailsScreen extends StatefulWidget {
  const ChargingStationDetailsScreen({Key? key}) : super(key: key);
...
class _ChargingStationDetailsScreenState extends State<ChargingStationDetailsScreen> with SingleTickerProviderStateMixin {
                      ...
                      children: [
                        ...
                        Expanded(
                          child: OutlinedButton(
                            ...
                            child: const Text('Route Planner'),
                          ),
                        ),
                      ],
                    ),
